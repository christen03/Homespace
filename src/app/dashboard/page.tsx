      ...
      <div className="flex w-full flex-row">
        <div className="w-1/4 bg-gray-100">
          ...
          <div className="ml-8 mr-8 mt-12 flex grid grid-cols-2 gap-4">
            <button className="mt-4 flex flex-row items-center justify-center rounded-3xl border-2 border-secondary px-6 py-2 text-center text-sm text-gray-600 ring  ring-gray-200 ring-opacity-50 transition duration-300 hover:scale-[1.02]">
              Clear Filters
            </button>
            <button className="mt-4 flex flex-row items-center justify-center rounded-3xl bg-secondary px-6 py-2 text-center text-sm text-white  ring ring-gray-200 ring-opacity-50 transition duration-300 hover:scale-[1.02]">
              Show Results
            </button>
          </div>
        </div>
