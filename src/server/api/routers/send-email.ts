...
export const sendEmailRouter = createTRPCRouter({
  ...
  sendEmail: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      const mailOptions = {
        to: input.email,
        from: "how2fly.app@gmail.com", // Replace with verified sender
    ...
    <html>
      ...
      <body>
        ...
        <p>Hi there,</p>
        <p>We're thrilled you're interested in Homespace! Thanks for signing up to be one of the first to know when we launch.</p>
        <p>We're working hard to create a unique and seamless experience for finding your perfect sublease, and we can't wait to share it with you soon.</p>
        ...
        <p>Sincerely,<br>The Homespace Team</p>
      </body>
    </html>
  `,
      };
